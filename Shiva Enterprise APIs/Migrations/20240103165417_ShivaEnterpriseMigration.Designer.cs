...
namespace Shiva_Enterprise_APIs.Migrations
{
    ...
    [Migration("20240103165417_ShivaEnterpriseMigration")]
    partial class ShivaEnterpriseMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shiva_Enterprise_APIs.Authentication.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Shiva_Enterprise_APIs.Authentication.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Shiva_Enterprise_APIs.Entities.RoleMembership", b =>
                {
                    ...
                    b.HasOne("Shiva_Enterprise_APIs.Authentication.ApplicationUser", "User")
                        .WithMany("RoleMemberships")
                        .HasForeignKey("UserID")
