...
=> optionsBuilder.UseSqlServer("Data Source=SMIT;Initial Catalog=ShivaEnterprise;User Id=sa;Password=sa@1;Integrated Security=true;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            //entity.ToTable("PurchaseReturn"); // Set the table name explicitly if needed
            entity.HasKey(e => e.PurchaseReturnId).HasName("PK__PurchaseReturn__B94AD674532DF6E8");
            ...
            entity.Property(e => e.ReturnQuantity).HasColumnName("ReturnQuantity").IsRequired();
            ...
            entity.Property(e => e.CreatedDateTime).HasColumnName("CreatedDateTime").IsRequired().HasDefaultValueSql("GETDATE()");
            entity.Property(e => e.ModifiedBy).HasColumnName("ModifiedBy").HasMaxLength(100);
            entity.Property(e => e.ModifiedDateTime).HasColumnName("ModifiedDateTime").HasDefaultValueSql("GETDATE()");
            entity.HasOne(e => e.PurchaseOrder).WithMany(o => o.PurchaseReturns).
              HasConstraintName("FK_PurchaseReturn_purchaseOrder");
        });
